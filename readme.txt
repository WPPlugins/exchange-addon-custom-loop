...
== Changelog ==
= 1.0.14 - 2016/04/04 =
* Minor Bug Fix: Fixed an issue causing notifications when wp_debug is enabled when the product categories addon is not activated

= 1.0.13 - 2016/02/11 =
* Minor Bug Fix: Fixed an issue where cmb datepicker css conflicts with other instances of jQuery ui datepicker

= 1.0.12 - 2016/02/05 =
* Bug Fix: Fixed an issue where the cart superwidget would not display properly on store pages
