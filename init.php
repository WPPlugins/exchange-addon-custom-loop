...
if (!class_exists('it_exchange_custom_loop')) {
        ...
        class it_exchange_custom_loop {
                ...
                function process() {
                        ...
                        // to avoid conflicts with any other filters on the_content
                        ...
                        if ($exchange_custom_loop->max_num_pages > 1) :
                                ...
                                if (!is_null($this->selections['order_by'])):
                                        ...
                                        array_push($pagination_args, array('orderby' => $this->selections['order_by']));
                        ...
                        // reset data, clear product to avoid conflict with SW-state on store page (product vs. cart)                        
                        wp_reset_postdata();
                        ...
                        // re-add the filter we removed at the top of this function to avoid conflicts
                        add_filter('the_content', array($this, 'process'));
